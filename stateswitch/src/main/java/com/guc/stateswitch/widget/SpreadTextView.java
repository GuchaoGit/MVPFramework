package com.guc.stateswitch.widget;
...
import com.guc.stateswitch.R;
import com.guc.stateswitch.utils.DensityUtils;
...
public class SpreadTextView extends View {
	...
	private void initAttribute(AttributeSet attrs, int defStyleAttr) {
		...
		mColor = typeArray.getColor(R.styleable.SpreadTextView_spread_text_color, Color.parseColor("#555555"));
		typeArray.recycle();
	}
